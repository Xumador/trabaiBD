...
public class QuerryController {
    ...
    public static String buscarProdutosPorPreco(double preco) throws SQLException {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                stringBuffer.append(rs.getInt("idCategoria"));
    ...
    public static String buscarProdutosPorNome(String nome) throws SQLException {
    ...
    public static String todosProdutos() throws SQLException {
